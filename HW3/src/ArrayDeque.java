 ...
 * @GTID 903845849
 *
 * Collaborators: LIST ALL COLLABO  RATORS YOU WORKED WITH HERE
 *
...
public class ArrayDeque<T> {
    ...
    public void addFirst(T data) {
        ...
        if (size == backingArray.length) {
            ...
            int i = 1, j = 0;
            while (size > j) {
                newArray[i] = backingArray[mod(front + j, size)];
                i++;
                j++;
            }
            front = 0;
...
//                newArray[i + 1] = mod(front + i, backingArray.length);
...
//            front = 0;
    ...
    public void addLast(T data) {
        ...
        if (size == backingArray.length) {
            ...
            int i = 0;
            while (size > i) {
                newArray[i] = backingArray[mod(front + i, size)];
                i++;
            }
            front = 0;
            backingArray = newArray;
//            for (int i = 0; i < size - 1; i++) {
//                newArray[i + 1] = mod(backingArray[(front + i)], backingArray.length);
//                //newArray[i + 1] = backingArray[(front + i) % backingArray.length];
//            }
//            newArray = backingArray;
//            front = 0;
    ...
    public T removeLast() {
        ...
        T returnedData = backingArray[mod(front + size - 1, backingArray.length)];
