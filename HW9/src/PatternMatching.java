...
public class PatternMatching {
    ...
    public static List<Integer> kmp(CharSequence pattern, CharSequence text,
        ...
        if (pattern == null || pattern.length() == 0) {
            throw new IllegalArgumentException("Input pattern can't be null or length = 0");
        }

        if (comparator == null || text == null) {
            throw new IllegalArgumentException("text/comparator cant be null");
        }
        int i = 0;
        int j = 0;
        ...
        failureTable[0] = 0;
        while (i <= text.length() - pattern.length()) { //so it doesnt go out of bounds
    ...
    public static int[] buildFailureTable(CharSequence pattern,
        ...
        if (pattern == null || comparator == null) {
            throw new IllegalArgumentException("Pattern/comparator cant be null");
        }
    ...
    public static Map<Character, Integer> buildLastTable(CharSequence pattern) {
        if (pattern == null) {
            throw new IllegalArgumentException("input pattern cant be null");
        }
    ...
    public static List<Integer> rabinKarp(CharSequence pattern,
        ...
        while (i <= n - m) {
            ...
            if (i < n - m) {
                textHash = (textHash - text.charAt(i) * base) * BASE + text.charAt(i + m);
            }
            i++;
        }
        return list;
    ...
    public static List<Integer> boyerMooreGalilRule(CharSequence pattern,
                                          ...
                                          CharacterComparator comparator) {
        if (pattern == null || pattern.length() == 0) {
            throw new IllegalArgumentException("Pattern cant be null or length = 0");
        }
