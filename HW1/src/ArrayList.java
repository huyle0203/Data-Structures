...
public class ArrayList<T> {
    ...
    public T removeAtIndex(int index) {
        if (index < 0 || index >= size) {
            throw new IndexOutOfBoundsException("The index cannot be less than 0 or greater or equal to size");
        }
        T dataRemoved = backingArray[index];
        //backingArray[index] = null; //extra steps
